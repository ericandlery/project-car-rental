...
/*         CSS改這個地方//////////////////////////// */
       .top{height:1300px;}
        #title{text-align: center;font-size:4em;font-weight:bold;color:#636363;font-family:標楷體;}
        ...
        #list{margin:60px;}
        .box{background-color:whitesmoke;height:700px;width:500px;display:inline-block;margin-left:100px;border:solid black;margin-top:50px;}
        .pics{border:solid red 4px;height:400px;}
        
        body{
  background: url(/TestRentalMVC/resources/background/silverstone.png) no-repeat center center fixed;
