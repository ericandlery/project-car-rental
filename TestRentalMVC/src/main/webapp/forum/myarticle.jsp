...
<script src="/TestRentalMVC/resources/js/jquery-tablepage-1.0.js"></script>
    <style>
        #lefttitle{
        	padding:20px;
        	width:10%;
...
<body>
		...
		<table id="bigtable" border=1 RULES=ROWS>
			...
			<c:choose>
				<c:when test="${myarticlelistNULL=='暫無發表文章'}">
	        		<tr><td colspan="2">暫無發表文章</td></tr>
	        	</c:when>
			</c:choose>
			
<!-- 			<form action="showmyArticle.controller" method="get">  -->
<!-- 				<input type="submit" value="查詢我的文章"> -->
<!-- 			</form> -->
			
			
			<c:forEach var="data" items="${myarticlelist}">
				<tr>
					<td>
...
<!-- 							<input type="submit" value="詳細內容"> -->
    ...
    <script>
		$("#bigtable").tablepage($("#table_page"), 8);
	</script>
</body>
</html>